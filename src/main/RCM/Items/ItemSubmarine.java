...
/*    */ 
/*    */ public class ItemSubmarine extends GlobalItem
/*    */ {
/*    */   public ItemSubmarine()
/*    */   {
/* 17 */     setRegistryName("item_submarine");
/* 18 */     ForgeRegistries.ITEMS.register(this);
/* 19 */     setTranslationKey("item_submarine");
...
/*    */     {
/* 30 */       EntitySubmarine rcentity = new EntitySubmarine(worldIn, blockpos.getX() + 0.5F, blockpos.getY() + 1.3F, blockpos.getZ() + 0.5F);
...
/* Location:              /Users/ethanejohnsons/Dropbox/The-RC-Mod-1.12.2.jar!/RCM/Items/ItemSubmarine.class
