...
/*    */ 
/*    */ public class ItemCar extends GlobalItem
/*    */ {
/*    */   public ItemCar()
/*    */   {
/* 17 */     setRegistryName("item_car");
/* 18 */     ForgeRegistries.ITEMS.register(this);
/* 19 */     setTranslationKey("item_car");
...
/*    */     {
/* 30 */       EntityCar rcentity = new EntityCar(worldIn, blockpos.getX() + 0.5F, blockpos.getY() + 1.3F, blockpos.getZ() + 0.5F);
...
/* Location:              /Users/ethanejohnsons/Dropbox/The-RC-Mod-1.12.2.jar!/RCM/Items/ItemCar.class
